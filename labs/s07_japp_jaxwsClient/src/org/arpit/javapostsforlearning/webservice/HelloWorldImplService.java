 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://webservice.javapostsforlearning.arpit.org/", wsdlLocation = "http://127.0.0.1:8080/WS/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://127.0.0.1:8080/WS/HelloWorld?wsdl");
