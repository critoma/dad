...
import jdk.incubator.http.*; //jdk 9
//import java.net.http.*; //jdk 11
import java.net.URI;
...
public class ProgMainHttp2Client {
	...
	public static void main(String[] args) throws IOException {
        try {
            ...
            //HttpRequest httpRequest = 
            //		HttpRequest.newBuilder().uri(new URI("http://127.0.0.1:8443/")).GET().build(); //Create a GET request for the given URI
